...
type MarketPlaceOffer struct {
	...
	FunPayOfferID string `protobuf:"bytes,6,opt,name=funPayOfferID,proto3" json:"funPayOfferID,omitempty"`
...
func (x *MarketPlaceOffer) GetFunPayOfferID() string {
	if x != nil {
		return x.FunPayOfferID
	}
	return ""
}
...
var file_drops_drops_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x79, 0x22, 0xce, 0x01, 0x0a, 0x10, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x50, 0x6c,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x49, 0x44, 0x12, 0x24, 0x0a, 0x0d, 0x66, 0x75,
	0x6e, 0x50, 0x61, 0x79, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x49, 0x44, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0d, 0x66, 0x75, 0x6e, 0x50, 0x61, 0x79, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x49, 0x44,
	...
	0x64, 0x65, 0x49, 0x44, 0x22, 0x60, 0x0a, 0x1e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x41,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x12, 0x2a, 0x0a, 0x10, 0x61, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x51, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x02,
	...
	0x64, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x32, 0x86, 0x0f, 0x0a, 0x0b, 0x44, 0x72, 0x6f, 0x70, 0x73, 0x43, 0x65, 0x6e, 0x74,
	...
	0x73, 0x65, 0x12, 0x56, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x72, 0x6b,
	0x65, 0x74, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x12, 0x24, 0x2e, 0x64,
	0x72, 0x6f, 0x70, 0x73, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x72, 0x6b, 0x65,
...
var file_drops_drops_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_drops_drops_proto_goTypes = []any{
	...
	(*ConnectAccountsWithGameRequest)(nil),  // 21: drops.ConnectAccountsWithGameRequest
	(*AccountWithDrops)(nil),                // 22: drops.AccountWithDrops
	(*SaveAccountsInfoRequest)(nil),         // 23: drops.SaveAccountsInfoRequest
	(*UpdateAccountsInfoRequest)(nil),       // 24: drops.UpdateAccountsInfoRequest
	(*DeletePreOrderedAccountsRequest)(nil), // 25: drops.DeletePreOrderedAccountsRequest
	(*DeleteAccountRequest)(nil),            // 26: drops.DeleteAccountRequest
	(*MovePreOrderAccountRequest)(nil),      // 27: drops.MovePreOrderAccountRequest
	(*SetEndTimeForAccountRequest)(nil),     // 28: drops.SetEndTimeForAccountRequest
	(*GetAllGameNamesResponse)(nil),         // 29: drops.GetAllGameNamesResponse
	(*UpdateGameChannelsRequest)(nil),       // 30: drops.UpdateGameChannelsRequest
	(*GetGamesRequest)(nil),                 // 31: drops.GetGamesRequest
	(*GetGamesResponse)(nil),                // 32: drops.GetGamesResponse
	(*Game)(nil),                            // 33: drops.Game
	(*GetAccountsRequest)(nil),              // 34: drops.GetAccountsRequest
	(*GetAccountsResponse)(nil),             // 35: drops.GetAccountsResponse
	(*UpdateAccountsRequest)(nil),           // 36: drops.UpdateAccountsRequest
	(*AddGameRequest)(nil),                  // 37: drops.AddGameRequest
	(*Token)(nil),                           // 38: drops.Token
	(*GetTokensForGameRequest)(nil),         // 39: drops.GetTokensForGameRequest
	(*GetTokensForGameResponse)(nil),        // 40: drops.GetTokensForGameResponse
	(*AccountWithData)(nil),                 // 41: drops.AccountWithData
	(*AddAccountsRequest)(nil),              // 42: drops.AddAccountsRequest
	nil,                                     // 43: drops.AccountWithDrops.DropsEntry
...
var file_drops_drops_proto_depIdxs = []int32{
	...
	38, // 1: drops.UpdateDropsAccountsInfoRequest.accounts:type_name -> drops.Token
	...
	43, // 5: drops.AccountWithDrops.drops:type_name -> drops.AccountWithDrops.DropsEntry
	22, // 6: drops.SaveAccountsInfoRequest.accounts:type_name -> drops.AccountWithDrops
	33, // 7: drops.GetGamesResponse.games:type_name -> drops.Game
	41, // 8: drops.GetAccountsResponse.accounts:type_name -> drops.AccountWithData
	38, // 9: drops.AccountWithData.token:type_name -> drops.Token
	44, // 10: drops.AccountWithData.endFarm:type_name -> google.protobuf.Timestamp
	38, // 11: drops.AddAccountsRequest.accounts:type_name -> drops.Token
	...
	45, // 14: drops.Drops.GetActiveGamesInfo:input_type -> google.protobuf.Empty
	...
	21, // 19: drops.DropsCenter.ConnectAccountsWithGame:input_type -> drops.ConnectAccountsWithGameRequest
	45, // 20: drops.DropsCenter.UpdateFarmList:input_type -> google.protobuf.Empty
	36, // 21: drops.DropsCenter.UpdateAccounts:input_type -> drops.UpdateAccountsRequest
	37, // 22: drops.DropsCenter.AddGame:input_type -> drops.AddGameRequest
	42, // 23: drops.DropsCenter.AddAccounts:input_type -> drops.AddAccountsRequest
	31, // 24: drops.DropsCenter.GetGames:input_type -> drops.GetGamesRequest
	34, // 25: drops.DropsCenter.GetAccounts:input_type -> drops.GetAccountsRequest
	30, // 26: drops.DropsCenter.UpdateGameChannels:input_type -> drops.UpdateGameChannelsRequest
	17, // 27: drops.DropsCenter.UpdateGameFarm:input_type -> drops.UpdateGameFarmRequest
	45, // 28: drops.DropsCenter.GetAllGameNames:input_type -> google.protobuf.Empty
	26, // 29: drops.DropsCenter.DeleteAccount:input_type -> drops.DeleteAccountRequest
	27, // 30: drops.DropsCenter.MovePreOrderAccount:input_type -> drops.MovePreOrderAccountRequest
	28, // 31: drops.DropsCenter.SetEndTimeForAccount:input_type -> drops.SetEndTimeForAccountRequest
	25, // 32: drops.DropsCenter.DeletePreOrderedAccounts:input_type -> drops.DeletePreOrderedAccountsRequest
	24, // 33: drops.DropsCenter.UpdateAccountsInfo:input_type -> drops.UpdateAccountsInfoRequest
	23, // 34: drops.DropsCenter.SaveAccountsInfo:input_type -> drops.SaveAccountsInfoRequest
	39, // 35: drops.DropsCenter.GetTokensForGame:input_type -> drops.GetTokensForGameRequest
	18, // 36: drops.DropsCenter.GetMarketplaceOffers:input_type -> drops.GetMarketplaceOffersRequest
	15, // 37: drops.DropsCenter.UpdateMarketplaceOffer:input_type -> drops.UpdateMarketplaceOfferRequest
	...
	45, // 43: drops.DropsViewers.StartWatch:output_type -> google.protobuf.Empty
	45, // 44: drops.DropsViewers.StopWatch:output_type -> google.protobuf.Empty
	2,  // 45: drops.Drops.GetActiveGamesInfo:output_type -> drops.GetActiveGamesInfoResponse
	45, // 46: drops.Drops.UpdateAccountsInfo:output_type -> google.protobuf.Empty
	45, // 47: drops.Drops.UpdateFarmList:output_type -> google.protobuf.Empty
	45, // 48: drops.Drops.ClearCollectedCampaigns:output_type -> google.protobuf.Empty
	7,  // 49: drops.Drops.GetCollectedCampaigns:output_type -> drops.GetCollectedCampaignsResponse
	45, // 50: drops.DropsCenter.ConnectAccountsWithGame:output_type -> google.protobuf.Empty
	45, // 51: drops.DropsCenter.UpdateFarmList:output_type -> google.protobuf.Empty
	45, // 52: drops.DropsCenter.UpdateAccounts:output_type -> google.protobuf.Empty
	45, // 53: drops.DropsCenter.AddGame:output_type -> google.protobuf.Empty
	45, // 54: drops.DropsCenter.AddAccounts:output_type -> google.protobuf.Empty
	32, // 55: drops.DropsCenter.GetGames:output_type -> drops.GetGamesResponse
	35, // 56: drops.DropsCenter.GetAccounts:output_type -> drops.GetAccountsResponse
	45, // 57: drops.DropsCenter.UpdateGameChannels:output_type -> google.protobuf.Empty
	45, // 58: drops.DropsCenter.UpdateGameFarm:output_type -> google.protobuf.Empty
	29, // 59: drops.DropsCenter.GetAllGameNames:output_type -> drops.GetAllGameNamesResponse
	45, // 60: drops.DropsCenter.DeleteAccount:output_type -> google.protobuf.Empty
	45, // 61: drops.DropsCenter.MovePreOrderAccount:output_type -> google.protobuf.Empty
	45, // 62: drops.DropsCenter.SetEndTimeForAccount:output_type -> google.protobuf.Empty
	45, // 63: drops.DropsCenter.DeletePreOrderedAccounts:output_type -> google.protobuf.Empty
	45, // 64: drops.DropsCenter.UpdateAccountsInfo:output_type -> google.protobuf.Empty
	45, // 65: drops.DropsCenter.SaveAccountsInfo:output_type -> google.protobuf.Empty
	40, // 66: drops.DropsCenter.GetTokensForGame:output_type -> drops.GetTokensForGameResponse
	19, // 67: drops.DropsCenter.GetMarketplaceOffers:output_type -> drops.GetMarketplaceOffersResponse
	45, // 68: drops.DropsCenter.UpdateMarketplaceOffer:output_type -> google.protobuf.Empty
	45, // 69: drops.DropsCenter.DeleteMarketplaceOffer:output_type -> google.protobuf.Empty
	45, // 70: drops.DropsCenter.CreateMarketplaceOffer:output_type -> google.protobuf.Empty
	14, // 71: drops.DropsCenter.GetFunPayOfferAccounts:output_type -> drops.GetFunPayOfferAccountsResponse
	45, // 72: drops.DropsCenter.EditMarketplaceOfferName:output_type -> google.protobuf.Empty
	45, // 73: drops.DropsCenter.SaveFunPayOfferID:output_type -> google.protobuf.Empty
