...
func (x *GetCategoryNamesResponse) Reset() {
	*x = GetCategoryNamesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCategoryNamesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCategoryNamesResponse) ProtoMessage() {}

func (x *GetCategoryNamesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_product_product_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCategoryNamesResponse.ProtoReflect.Descriptor instead.
func (*GetCategoryNamesResponse) Descriptor() ([]byte, []int) {
	return file_product_product_proto_rawDescGZIP(), []int{3}
}

func (x *GetCategoryNamesResponse) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
var file_product_product_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x5c, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x47, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20,
	...
	0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x7e, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x12, 0x0a,
	...
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x30, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0xa2, 0x01, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64,
	...
	0x10, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65,
	0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x21, 0x2e, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4e,
	0x61, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x21, 0x5a, 0x1f,
...
var file_product_product_proto_goTypes = []interface{}{
	...
	(*GetCategoryNamesResponse)(nil), // 3: product.GetCategoryNamesResponse
...
var file_product_product_proto_depIdxs = []int32{
	...
	4, // 2: product.Product.GetCategoryNames:input_type -> google.protobuf.Empty
	1, // 3: product.Product.GetCategory:output_type -> product.GetGategoryResponse
	3, // 4: product.Product.GetCategoryNames:output_type -> product.GetCategoryNamesResponse
...
func file_product_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_product_product_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCategoryNamesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
