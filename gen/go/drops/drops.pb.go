...
var file_drops_drops_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x68, 0x22, 0xc6, 0x01, 0x0a, 0x0f, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x57,
	...
	0x22, 0x56, 0x0a, 0x0e, 0x52, 0x75, 0x6e, 0x47, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x52, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x22, 0xac, 0x01, 0x0a, 0x12, 0x52, 0x75, 0x6e,
	...
	0x6c, 0x61, 0x69, 0x6d, 0x69, 0x6e, 0x67, 0x22, 0x21, 0x0a, 0x0b, 0x53, 0x74, 0x6f, 0x70, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x67, 0x61, 0x6d, 0x65, 0x22, 0x43, 0x0a, 0x1a, 0x47, 0x65,
	...
	0x6e, 0x73, 0x65, 0x32, 0x8e, 0x02, 0x0a, 0x0b, 0x44, 0x72, 0x6f, 0x70, 0x73, 0x43, 0x65, 0x6e,
...
var file_drops_drops_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_drops_drops_proto_goTypes = []interface{}{
	...
	(*AccountWithData)(nil),            // 6: drops.AccountWithData
	(*AddAccountsRequest)(nil),         // 7: drops.AddAccountsRequest
	(*RunGameRequest)(nil),             // 8: drops.RunGameRequest
	(*RunChannelsRequest)(nil),         // 9: drops.RunChannelsRequest
	(*StopRequest)(nil),                // 10: drops.StopRequest
	(*GetActiveGamesInfoResponse)(nil), // 11: drops.GetActiveGamesInfoResponse
	(*GameInfo)(nil),                   // 12: drops.GameInfo
	nil,                                // 13: drops.AccountWithData.DropsEntry
	(*emptypb.Empty)(nil),              // 14: google.protobuf.Empty
}
var file_drops_drops_proto_depIdxs = []int32{
	2,  // 0: drops.GetGamesResponse.games:type_name -> drops.Game
	5,  // 1: drops.AccountWithData.token:type_name -> drops.Token
	13, // 2: drops.AccountWithData.drops:type_name -> drops.AccountWithData.DropsEntry
	5,  // 3: drops.AddAccountsRequest.accounts:type_name -> drops.Token
	12, // 4: drops.GetActiveGamesInfoResponse.games:type_name -> drops.GameInfo
	8,  // 5: drops.Drops.RunGame:input_type -> drops.RunGameRequest
	9,  // 6: drops.Drops.RunChannels:input_type -> drops.RunChannelsRequest
	10, // 7: drops.Drops.Stop:input_type -> drops.StopRequest
	14, // 8: drops.Drops.GetActiveGamesInfo:input_type -> google.protobuf.Empty
	3,  // 9: drops.DropsCenter.UpdateAccounts:input_type -> drops.UpdateAccountsRequest
	4,  // 10: drops.DropsCenter.AddGame:input_type -> drops.AddGameRequest
	7,  // 11: drops.DropsCenter.AddAccounts:input_type -> drops.AddAccountsRequest
	0,  // 12: drops.DropsCenter.GetGames:input_type -> drops.GetGamesRequest
	14, // 13: drops.Drops.RunGame:output_type -> google.protobuf.Empty
	14, // 14: drops.Drops.RunChannels:output_type -> google.protobuf.Empty
	14, // 15: drops.Drops.Stop:output_type -> google.protobuf.Empty
	11, // 16: drops.Drops.GetActiveGamesInfo:output_type -> drops.GetActiveGamesInfoResponse
	14, // 17: drops.DropsCenter.UpdateAccounts:output_type -> google.protobuf.Empty
	14, // 18: drops.DropsCenter.AddGame:output_type -> google.protobuf.Empty
	14, // 19: drops.DropsCenter.AddAccounts:output_type -> google.protobuf.Empty
