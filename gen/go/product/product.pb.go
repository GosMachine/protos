...
func (x *GetCategoriesResponse) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
func (x *GetCategoriesResponse) GetSlugs() []string {
	if x != nil {
		return x.Slugs
	}
	return nil
...
var file_product_product_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x43, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x43, 0x61,
	...
	0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x6c, 0x75, 0x67, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x73, 0x6c, 0x75, 0x67, 0x73, 0x32, 0xdd, 0x01, 0x0a,
	...
	0x73, 0x65, 0x12, 0x47, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
...
var file_product_product_proto_depIdxs = []int32{
	...
	2, // 2: product.Product.GetCategory:input_type -> product.GetCategoryRequest
	7, // 3: product.Product.GetCategories:input_type -> google.protobuf.Empty
	0, // 4: product.Product.Checkout:input_type -> product.CheckoutRequest
	3, // 5: product.Product.GetCategory:output_type -> product.GetGategoryResponse
	6, // 6: product.Product.GetCategories:output_type -> product.GetCategoriesResponse
	1, // 7: product.Product.Checkout:output_type -> product.CheckoutResponse
